...
public class PaperWaystoneModule implements Listener, CancellableModule {
    ...
    private void handleWaystoneInventoryClick(Player player, ItemStack clickedItem, ClickType clickType) {
        ...
        if (clickType == ClickType.LEFT || clickType == ClickType.SHIFT_LEFT) {
            ...
            Location waystoneCenter = targetWaystone.getLocation().clone().add(0.5, 0, 0.5);
            destination.setDirection(waystoneCenter.toVector().subtract(destination.toVector()).normalize());
