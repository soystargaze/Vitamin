...
public class TranslationHandler {
    ...
    public static Component getPlayerMessage(String key, Object... args) {
        String prefix = translations.getOrDefault("plugin.prefix", "<color:#d4d4d4>[</color><gradient:#4CAF50:#CDDC39>Vivid+</gradient><color:#d4d4d4>]</color> ");
        String dynamicColor = translations.getOrDefault("plugin.dynamic_color", "<color:#4CAF50>");
    ...
    public static Component getLogMessage(String key, Object... args) {
        String prefix = translations.getOrDefault("plugin.prefix", "<gray>[<gradient:#4CAF50:#CDDC39>Vivid+</gradient>]</gray> ");
        String template = translations.getOrDefault(key, "Translation not found: " + key + "!");
        String dynamicColor = translations.getOrDefault("plugin.dynamic_color", "<color:#4CAF50>");
