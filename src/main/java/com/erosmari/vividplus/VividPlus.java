package com.erosmari.vividplus;

import com.erosmari.vividplus.commands.VividPlusCommandManager;
import com.erosmari.vividplus.config.ConfigHandler;
import com.erosmari.vividplus.modules.ModuleManager;
import com.erosmari.vividplus.utils.*;
...
public class VividPlus extends JavaPlugin implements Listener {

    private static VividPlus instance;
    private ModuleManager moduleManager;
    private VividPlusCommandManager commandManager;
    ...
    private void initializeCommandManager() {
        try {
            if (commandManager == null) {
                commandManager = new VividPlusCommandManager(this);
    ...
    public static VividPlus getInstance() {
        return instance;
    }
